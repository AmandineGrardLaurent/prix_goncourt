...
def add_votes_in_selection(goncourt: Goncourt, selection_nb: int) -> None:
    ...
    if success:
        print(f"Les votes pour la sélection {selection_nb} ont été enregistrés avec succès.\n")
    else:
